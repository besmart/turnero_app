...
class LoginsControllerTest < ActionController::TestCase
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post :create, login: { clase_usuario: @login.clase_usuario, estado: @login.estado, sesion: @login.sesion, usuario_id: @login.usuario_id }
    end
  ...
  test "should update login" do
    patch :update, id: @login, login: { clase_usuario: @login.clase_usuario, estado: @login.estado, sesion: @login.sesion, usuario_id: @login.usuario_id }
    assert_redirected_to login_path(assigns(:login))
  end
