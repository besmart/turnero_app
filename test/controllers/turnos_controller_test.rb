...
class TurnosControllerTest < ActionController::TestCase
  ...
  test "should create turno" do
    assert_difference('Turno.count') do
      post :create, turno: { agencia_id: @turno.agencia_id, comentario_atencion: @turno.comentario_atencion, descripcion: @turno.descripcion, estado: @turno.estado, hora_atencion: @turno.hora_atencion, hora_finalizacion: @turno.hora_finalizacion, hora_ingreso: @turno.hora_ingreso, nombre: @turno.nombre, resumen: @turno.resumen, usuario_id: @turno.usuario_id }
    end
  ...
  test "should update turno" do
    patch :update, id: @turno, turno: { agencia_id: @turno.agencia_id, comentario_atencion: @turno.comentario_atencion, descripcion: @turno.descripcion, estado: @turno.estado, hora_atencion: @turno.hora_atencion, hora_finalizacion: @turno.hora_finalizacion, hora_ingreso: @turno.hora_ingreso, nombre: @turno.nombre, resumen: @turno.resumen, usuario_id: @turno.usuario_id }
    assert_redirected_to turno_path(assigns(:turno))
  end
