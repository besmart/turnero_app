class EvaluacionesController < ApplicationController
  ...
  private
    ...
    def evaluacion_params
      params.require(:evaluacion).permit(:turno_id, :pregunta1, :resultado1, :pregunta2, :resultado2, :pregunta3, :resultado3, :pregunta4, :resultado4, :comentario, :resultado_total)
    end
end
